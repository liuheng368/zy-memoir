...
/**
 * cloudfunctions/updateTeacherAvatar/index.js
 *
 * plan API-15：老师换头像（仅本人或 admin）。
 * 入参：{ token, fileID, url? }（fileID 必填；url 若不传则由 SDK 处理后再写）
 * 出参：
 *   成功 → { ok: true, code: 'AVATAR_OK', data: { avatar } }
...
exports.main = async (event = {}) => {
  ...
  try {
    ...
    const avatar = { fileID, url: typeof url === 'string' ? url : '' };
